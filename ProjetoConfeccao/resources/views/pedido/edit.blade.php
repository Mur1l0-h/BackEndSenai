                    ...
                    <form action="{{ route('pedido.update', $pedido) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="valor" id="valor" value="{{ $pedido->valor }}" required 
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-gray-800 focus:ring-gray-800 sm:text-sm transition duration-150 ease-in-out">
                                @error("valor")
                                    <span class="text-sm text-red-500 mt-1 block">{{ $message }}</span>
                                @enderror
                        ...
                        <div>
                            ...
                            <input type="number" name="fornecedors_id" id="fornecedors_id" value="{{ $pedido->fornecedors_id }}" required 
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-gray-800 focus:ring-gray-800 sm:text-sm transition duration-150 ease-in-out">
